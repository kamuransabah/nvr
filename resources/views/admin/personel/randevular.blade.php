...
@section('title', 'Data Randevu Listesi')
@section('css')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-gray-900 fw-bold my-1 fs-3">Data Randevular</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-900">Data Randevu Listesi</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div class="card-body pt-0">
            ...
            <table class="table table-row-bordered align-middle gy-5 gs-7" id="datatable">
                ...
                <tr class="fw-semibold fs-6 text-gray-800">
                    ...
                    <th style="min-width: 220px;" class="text-end">İşlem</th>
                </tr>
                </thead>
            </table>
            <!--end::Table-->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route(config('system.personel_prefix').'.randevu.datatable') }}',
                    data: function (d) {
                        d.arama = $('#arama').val();
                        d.urun = $('#urun').val();
                ...
                columns: [
                    ...
                    { data: 'urun', name: 'urun' },
                    { data: 'gorusme_tarihi', name: 'gorusme_tarihi' },
                    { data: 'randevu_tarihi', name: 'randevu_tarihi' },
                    { data: 'islem', name: 'islem', orderable: false, searchable: false }
                ],
                columnDefs: [
                    { targets: 0, width: '120px', className: 'text-start' },
                    { targets: -1, width: '220px', className: 'text-end' }
                ],
            ...
            // Responsive child row açıldığında da bağla
            $('#datatable')
