        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap lh-1">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-900">Sayfa Listesi</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route(config('system.admin_prefix').'.sayfa.add') }}" class="btn btn-sm fw-bold btn-success"><i class="fas fa-plus fs-4 me-2"></i>Yeni Sayfa Ekle</a>
                <!--end::Primary button-->
            </div>
        </div>
        <!--end::Container-->
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#blogs-table').DataTable({
                ...
                ajax: {
                    url: '{{ route(config('system.admin_prefix').'.sayfa.data') }}',
                    data: function (d) {
                        d.baslik = $('#baslik').val();
