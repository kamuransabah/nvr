    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-gray-900 fw-bold my-1 fs-3">Sınavlar</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-900">Sınav Listesi</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex align-items-center py-1">
                <a href="{{ route(config('system.admin_prefix').'.sinav.add') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-circle me-2"></i>Yeni Sınav Ekle</a>
            </div>
            <!--end::Actions-->
        </div>
        <!--end::Container-->
        ...
        <div class="card-header align-items-center py-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end">
                <div class="row w-100 d-flex justify-content-between align-items-center">
                    <div class="col-md-2">
                        <label class="form-label" for="sinav_adi">Sınav</label>
                        <input type="text" class="form-control" name="sinav_adi" id="sinav_adi" placeholder="Sınav Adı">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label" for="kurs_id">Kurs</label>
                        <select id="kurs_id" class="form-select text-capitalize" data-control="select2" data-placeholder="Kurs Seçiniz">
                    ...
                    <div class="col-md-2">
                        <label class="form-label" for="tur">Sınav Türü</label>
                        <select id="tur" class="form-select text-capitalize">
                            <option value="">Tümü</option>
                            @foreach($sinavTurleri as $tur)
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route(config('system.admin_prefix').'.sinav.data') }}',
                    data: function (d) {
                        d.sinav_adi = $('#sinav_adi').val();
                        d.kurs_id = $('#kurs_id').val();
                        d.tur = $('#tur').val();
